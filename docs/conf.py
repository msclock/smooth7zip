...
html_favicon = 'https://img.shields.io/badge/S-blue'
...
html_theme_options = {
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/msclock/smooth7zip",
            "html": "",
...
breathe_projects = {"smooth7zip-doxygen": f"{ROOT}/docs/_build/doxygen/xml"}
breathe_default_project = "smooth7zip-doxygen"
